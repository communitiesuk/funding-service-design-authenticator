...
class Notification(object):
    ...
    @staticmethod
    def send(template_type: str, to_email: str, content: dict, reference: str | None = None):
        """
        ...
        if reference:
            # TODO: "should" be from NotifyConstants.FIELD_NOTIFY_REFERENCE
            params["govuk_notify_reference"] = reference
