...
def not_found(error):
    return render_template("404.html",
                           accessibility_statement_url=Config.APPLICANT_FRONTEND_ACCESSIBILITY_STATEMENT_URL), 404


@default_bp.errorhandler(500)
def internal_server_error(error):
    return render_template("500.html",
                           accessibility_statement_url=Config.APPLICANT_FRONTEND_ACCESSIBILITY_STATEMENT_URL), 500
